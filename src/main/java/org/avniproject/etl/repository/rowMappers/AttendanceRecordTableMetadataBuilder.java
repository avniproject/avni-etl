...
import org.avniproject.etl.repository.rowMappers.tableMappers.AttendanceRecordTable;

import java.util.stream.Collectors;

public class AttendanceRecordTableMetadataBuilder {
    public static TableMetadata build() {
        TableMetadata tableMetadata = new TableMetadata();
        AttendanceRecordTable table = new AttendanceRecordTable();
        tableMetadata.setName(table.name(null));
        tableMetadata.setType(TableMetadata.Type.AttendanceRecord);
